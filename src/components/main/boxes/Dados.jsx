const data = {
  title: 'Fundamentos da Produção de Moda',
  apresentacao: [
    {
      titulo: 'APRESENTAÇÃO'
    },
    {
      parag: `A moda transcende a simples função de vestimenta, tornando-se uma
    ...
    {
      parag: `Dentro dos projetos de exposição de produto, projetos de imagem e eventos
    ...
    {
      parag: `A produção de moda é responsável pela transformação de conceitos 
  ...
  contexto: [
    ...
    {
      parag: `Na disciplina de Fundamentos da Produção de Moda, convidamos os estudantes
    ...
    {
      parag: `No decorrer da unidade curricular, os alunos serão guiados na construção de 
    ...
    {
      parag: `Ao final da unidade curricular, você será capaz de reconhecer e identificar as 
    ...
    },
    {
      ...
      texto: {
        prag1:`Chegamos ao fim desta jornada de aprendizado em Fundamentos da Produção 
               ...
               tendências, técnicas de styling, gerenciamento de produção e muito 
  ...
  videos: [
    {
      id: 0,
      title: 'História da Produção de Moda',
      descricao: 'Assista ao vídeo e conheça mais sobre a História da Produção de Moda.',
      url: 'https://youtu.be/rZlO8wAW1vg?list=PLPli_KFbLinGXZkNL_vdalCnOHpMV4xAO',
      fonte: 'Vídeo 1 - História da Produção de Moda. Fonte: SENAI Play 11/03/2024.'
    },
    {
      id: 1,
      title: 'Projetos de Imagem',
      descricao: 'Assista ao vídeo para se aprofundar no mundo dos projetos de imagem na produção de moda.',
      url: 'https://youtu.be/91K01Q_O-Po?list=PLPli_KFbLinGXZkNL_vdalCnOHpMV4xAO',
      fonte: 'Vídeo 2 - Projetos de Imagem. Fonte: SENAI Play (YouTube), 11/03/2024.'
    },
    {
      id: 2,
      title: 'A RELAÇÃO ENTRE MODA E IMAGEM',
      descricao: 'Assista ao vídeo e conheça mais sobre a relação entre moda e imagem',
      url: 'https://www.youtube.com/watch?v=ldyI4wCLBwA',
      fonte: 'Vídeo 3 - A RELAÇÃO ENTRE MODA E IMAGEM. Fonte: O POVO, 11/03/2024.'
    },
    {
      id: 3,
      title: 'Projetos de Exposição de Produtos e Eventos de Moda',
...
autor:[
  {
    ...
    biografia:[
        `Priscila Keunecke da Silva é bacharel
         ...
         Especialista em Gestão e Docência no ensino
         superior, médio e técnico pela Faculdade de
         São Vicente - FSV desde 2019 e Especialista 
         em Moda pelo Instituto Federal Catarinense - IFC desde 2023.`,
        `Com 11 anos de experiência em diversos setores na 
